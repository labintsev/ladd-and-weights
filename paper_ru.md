...
Среднее значение площащи объкта на снимке составляет около 5000 квадратных пикселей. 
Гистограмма распределения площади объектов приведена на рисунке. 
...
Таким образом, в нашем распоряжении имеется три разных варианта одинаковых данных, с разным соотношением площади объектов к площади изображения (1:2400, 1:1200 и 1:400).  
...
Полученные результаты позволяют достичь оптимального баланса скорости и точности на различных вычислительных устройствах. 
Дальнейшие исследования направлены на обучение архитектур трансформеров и сравнение их со сверточными нейронными сетями.  
